...
%
\authorrunning{Universidad de la Habana, Facultad de Matemática y Computación }
% First names are abbreviated in the running head.
% If there are more than two authors, 'et al.' is used.
%
\institute{Facultad de Matemática y Computación, Universidad de la Habana\\
\inst{1}\email{javier.rs0808@gmail.com}}
%
\maketitle 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%                            ABSTRACT                         %%
...
15--250 words.
\keywords{Programación de Satisfacción de Restricciones \and Programación entera.}
\end{abstract}
%
...
Considerese la siguiente fórmula en FNC:
